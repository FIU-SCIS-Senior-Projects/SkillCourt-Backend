...
var s0 = new buzz.sound( "./audio/s0", { formats: [ "ogg", "mp3"] });
var s1 = new buzz.sound( "./audio/s1", { formats: [ "ogg", "mp3"] });
var s2 = new buzz.sound( "./audio/s2", { formats: [ "ogg", "mp3"] });
var s3 = new buzz.sound( "./audio/s3", { formats: [ "mp3"] });
...
function startGame()
{
	processingInstance = Processing.getInstanceById('sketchSimulator');
...
function showDefault()
{
	...
	location.reload() ;
    window.location.assign("./index.php?show=simulator");
}
