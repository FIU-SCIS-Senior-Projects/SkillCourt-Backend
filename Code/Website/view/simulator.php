		...
		<div clas="col-lg-7">
			...
			<div id="SimSettings">
				...
				<div class="SettingsList" id="DefaultList">
					...
					<ul>
						<li id="sStep4"><input id="customRoomCheck" type="checkbox" onclick="switchCustom();"/>Remove Wall</li>
						...
						<li id="sStep5"><select id="routineType" onchange="allowRounds();">
					...
					<li id="difficultyRadioButton">
						...
						<li id="sStep7"><input id="timePerRoundCheck" type="checkbox" onclick="myFunction2();">
						...
						<li id="sStep9"><button onclick="startGame();">Play!</button></li>
	                </ul>
				</div>
